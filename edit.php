	    ...
	    if(empty($errors)){
	         ...
	         $net_amount  = mysqli_real_escape_string($connection, $_POST['net_amount']);
	  	      ...
	  	      //Prepare database query
	             $query = "UPDATE salary SET paysheet_no='$paysheet_no', name='$name', month='$month', staff_no='$staff_no', b_salary='$b_salary', loan='$loan', leave='$leave', ot='$ot', advance='$advance', net_amount='$net_amount'";
